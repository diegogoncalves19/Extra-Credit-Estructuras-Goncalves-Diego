 ...
 * @author Windows Pro
 */
public class JugarAdivinar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JugarAdivinar
     */
    public JugarAdivinar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("\tBienvenido al juego de adivinar! \n\nInstrucciones:\n\nEl pokémon te va a mostrar todos los regalos que están en la tienda,\nenumerados del 1 al 9, y él va a escoger un número aleatorio del \n1 al 9. Tú tienes que adivinar que número está pensando para poder\nganar el juego. Si aciertas, te ganas el doble de watts que apostaste. \nTambién podras perderlos todos pero a su vez obtener unos puntos \nde amistad con tu pokémon.");
        ...
        jLabel2.setText("Ingresa los watts que quiere apostar");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 440, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        EscogerPensamiento(wattsapostados, getWatts(), getAmistad());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JugarAdivinar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JugarAdivinar().setVisible(true);
            }
        });
    }
    
    public void EscogerPensamiento(int wattsapostados, int watts, int amistad){
        ...
        if (wattsapostados > watts) {
            ...
            JOptionPane.showMessageDialog(null, """
                                                La lista de regalos que est\u00e1n en la tienda son:
                                                1. Baya Aranja
                                                2. Baya Caquic
                                                3. Pokeball
                                                4. Baya Zreza
            ...
            String respuesta = JOptionPane.showInputDialog("¿Cuál crees que es el número que está pensando el Pokemon?");
            
            int num1 = random.nextInt(9)+1;

            if (Integer.parseInt(respuesta) == num1) {
                    JOptionPane.showMessageDialog(null, "El número es " + num1 + ". Acertaste!");
                    watts += (wattsapostados * 2);
                    setWatts(watts);                
            }else{
                    JOptionPane.showMessageDialog(null, "El número es " + num1 + ". Fallaste!");
